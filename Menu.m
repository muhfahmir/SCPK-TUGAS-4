...
% Last Modified by GUIDE v2.5 06-Mar-2020 23:56:28
...
% --- Executes on button press in btnKabisat.
function btnKabisat_Callback(hObject, eventdata, handles)
% hObject    handle to btnKabisat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close
Kabisat
...
% --- Executes on button press in btnBalok.
function btnBalok_Callback(hObject, eventdata, handles)
% hObject    handle to btnBalok (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close
Balok
...
% hObject    handle to mKeluar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close
